...
public class POSSystem {
	...
	public int printMenu(){
		...
		System.out.println("--------------");
		System.out.print("원하시는 번호를 입력해주세요.(이외번호를 입력하시면 프로그램을 종료합니다.)");
		
		return sc.nextInt();
	}
	//회원가입 정보를 입력받아 배열에 저장하는 매서드
...
//		saveCustomer(insertCustomer());
	...
	public Customer insertCustomer() {
		...
		email = sc.next();
		Customer tmp = new Customer(name, pw, id, email);
		return tmp;
//		return new Customer(name, pw, id, email);
	}
